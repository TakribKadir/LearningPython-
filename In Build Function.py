...
#Task 9: Uncomment the above lines to test input in a script

#10. help() - Shows documentation of a function (works in REPL, not shown in output)
# Uncomment to try it in Python console:
# help(len)
